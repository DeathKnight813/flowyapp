                    ...
                    children: [
                      OutlinedButton(
                        onPressed: () {
                          ...
                          afLaunchUrlString(
                            'https://github.com/VictorRaynor/AppFlowy/issues/new?assignees=&labels=&projects=&template=bug_report.yaml&title=[Bug]%20Mobile:%20&version=$version&os=$os&context=Error%20log:%20$errorMsg',
                          );
                        },
                        child: Text(
